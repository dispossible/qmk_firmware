...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BL] = LAYOUT(
    KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_NUM,   KC_HOME,  KC_END,   KC_PSCR,  KC_INS,
  ...
  [_FL] = LAYOUT(
    _______,  KC_MUTE,  KC_VOLD,  KC_VOLU,  _______,  KC_MPRV,  KC_MPLY,  KC_MNXT,  _______,  _______,  _______,  RGB_VAD,   RGB_VAI,   _______,  _______,  _______,  _______,  _______,
